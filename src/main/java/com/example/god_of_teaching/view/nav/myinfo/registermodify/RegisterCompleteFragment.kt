package com.example.god_of_teaching.view.nav.myinfo.registermodify
...
import com.example.god_of_teaching.databinding.FragmentRegisterCompleteBinding
...
class RegisterCompleteFragment : Fragment() {
    ...
    private fun complete()
    {
        ...
        when(completeItem)
        {
            "teacher" ->
            {
                teacherView.changeTeacherStatus()
            }
            "student" ->
            {
                studentView.changeStudentStatus()
            }
            "academy" ->
            {
