...
import com.example.god_of_teaching.databinding.FragmentAuthAcademyBinding
...
//학원 등록증 확인하는 프래그먼트
@AndroidEntryPoint
class AuthAcademyFragment : Fragment() {
    private val REQUEST_GALLERY = 1001
    private var resultUri: Uri?=null
    private var _binding: FragmentAuthAcademyBinding?=null
    private val binding get() = _binding!!
    private val academyView : AcademyViewModel by viewModels()
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentAuthAcademyBinding.inflate(inflater,container,false)
    ...
    private fun basicSetting()
    {
        ...
        binding.toolbarTitleAuthAcademy.text = "학원 등록하기"
...
//            } else {
//                val navController = findNavController()
//                academyView.uploadAuthImage(resultUri!!)
//                navController.popBackStack()
//                navController.navigate(R.id.academyLocalFragment)
//            }
            val navController = findNavController()
            navController.popBackStack()
            navController.navigate(R.id.academyLocalFragment)
