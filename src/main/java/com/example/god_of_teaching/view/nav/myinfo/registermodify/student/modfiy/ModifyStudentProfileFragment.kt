...
import com.example.god_of_teaching.databinding.FragmentModifyStudentProfileBinding
...
class ModifyStudentProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater,R.layout.fragment_modify_student_profile,container,false)
...
//        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_GALLERY && resultCode == AppCompatActivity.RESULT_OK) {
            ...
            context?.let { studentView.uplodeStudentProfileImageToLocal(resultUri!!, it) }
            //사이즈 조절
