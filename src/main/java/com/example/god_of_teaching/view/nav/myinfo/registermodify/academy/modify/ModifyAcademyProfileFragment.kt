...
import com.example.god_of_teaching.databinding.FragmentModifyAcademyProfileBinding
...
class ModifyAcademyProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater,R.layout.fragment_modify_academy_profile,container,false)
...
//        dialog.show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_GALLERY && resultCode == AppCompatActivity.RESULT_OK) {
            ...
            context?.let { academyView.uplodeAcademyProfileImageToLocal(resultUri!!, it) }
            //사이즈 조절
...
//            academyDataStoreHelper.getClassAge.collect { value ->
//                val items = value.split(",").map { value.trim() }   // 쉼표를 기준으로 분리
//                classAge?.addAll(items)
//            }
//            Log.d("123123123",classAge.toString())
//        }
//    }
