...
//선생님 활동 가능한 지역 수정하는 코드
@AndroidEntryPoint
class ModifyTeacherLocalFragment : Fragment() {
    ...
    private lateinit var myLocal : String
    ...
    private fun next()
    {
        binding.btnNextChoiceLocal.setOnClickListener {
            if (myLocalList.isNotEmpty()) {
                ...
                teacherView.modifyTeacherInfoArray("지역", myLocalList)
                val navController = findNavController()
    ...
    private fun getExistingItem()
    {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            teacherDataStoreHelper.getAvailableLocal.collect { value ->
                myLocal = value
            }
    ...
    //기존항목 어댑터 표시하기
    private fun getExistingItemAdapter()
    {
        myLocal?.let {
