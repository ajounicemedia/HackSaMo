...
class StudentDatastoreHelper(context : Context) {
    ...
    private val des = stringPreferencesKey("Student_Description")
    private val bornYear = stringPreferencesKey("Student_BornYear")
    ...
    private val introduce = stringPreferencesKey("Student_Introduce")
