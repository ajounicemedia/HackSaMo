...
class TeacherDataStoreHelper(context : Context) {
    ...
    private val nickname = stringPreferencesKey("Teacher_Nickname")
    private val des = stringPreferencesKey("Teacher_Description")
    private val bornYear = stringPreferencesKey("Teacher_BornYear")
    ...
    private val introduce = stringPreferencesKey("Teacher_Introduce")
