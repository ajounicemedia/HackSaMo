...
import god.example.god_of_teaching.databinding.FragmentAuthAcademyBinding
...
class AuthAcademyFragment : Fragment() {
    ...
    private fun basicSetting()
    {
        ...
        binding.toolbarTitleAuthAcademy.text = "학원 인증하기"
    ...
    private fun next() {
        binding.btnNextAuthAcademy.setOnClickListener {
            if (resultUri == null) {
                ...
                val navController = findNavController()
                academyView.uploadAcademyAuthImage(resultUri!!)
